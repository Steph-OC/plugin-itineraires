...
if (!class_exists('My_Trail_Map')) {
    ...
    class My_Trail_Map
    {
        ...
        public function enqueue_scripts()
        {
            ...
            // Enqueue FontAwesome Kit
            wp_enqueue_script('font-awesome-kit', 'https://kit.fontawesome.com/277d797764.js', array(), null, true);

            // Enqueue Leaflet Fullscreen CSS and JS
            wp_enqueue_style('leaflet-fullscreen-css', 'https://cdnjs.cloudflare.com/ajax/libs/leaflet.fullscreen/1.6.0/Control.FullScreen.css', array(), null, 'all');
            wp_enqueue_script('leaflet-fullscreen-js', 'https://cdnjs.cloudflare.com/ajax/libs/leaflet.fullscreen/1.6.0/Control.FullScreen.min.js', array('leaflet-js'), null, true);
            ...
            wp_localize_script('trail-map', 'pluginDirUrl', array(
                ...
                'showAllButton' => get_option('trail_map_show_all_button', true)
            ));
        }
